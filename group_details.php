	...
	echo "<form method = 'post'>
			...
			echo"			</table>
							<div class = 'form-group'>
								<a href = 'create_topic.php' class = 'button3'>Create Topic</a>";
								echo " ";
								if($_SESSION['id']==$admin){
								echo "<input type = 'submit' value = 'Remove From Group' name = 'remove' class = 'button3'>";
								}
						echo"	</div>
						</div>
				</form>";
...
echo "<a href='myTopic.php' class = 'button3'>View Topics</a>";
