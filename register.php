...
<!--[if gt IE 8]><!--> <html class="no-js" lang=""> <!--<![endif]-->
    ...
    <body>
      ...
      <div class="container">
	   ...
	   <a href="#" class="pull-left"><img class = "img-responsive" src="logo.png"></a>
...
<form method="post">
    ...
    <input name="submit" type="submit" value="Register" class = "button1">
	<input name="reset" type="reset" value="Reset" class = "button1">
</form>
