...
<?php
	...
	if($category == 1){
		...
		if($download){
			echo "<div class = 'row'>
					<div class = 'col-md-2'>
						<a class = 'button1' href='file_download.php?name=$path'>Download</a>
					</div>
					<div class = 'col-md-2'>
						<form method = 'post'>
							<div class='form-group'>
								<input type = 'submit' value = 'Favourites' name = 'favourites' class = 'button2'>
							</div>
						</form>
					</div>
					<div class = 'col-md-2'>
						<form method = 'post'>
							<div class='form-group'>
								<input type = 'submit' value = 'Block' name = 'block' class = 'button1'>
							</div>
						</form>
					</div>
					<div class = 'col-md-2'>
					...
					<div class = 'col-md-3'>
						<a class = 'button3' href='add_playlist.php?media=$mediaId'>Add to Playlist</a>
					</div>
				</div>";
		}
		else{
		...
		if($ratingAccess){
			echo"<form method = 'post'>
					<div class='form-group'>
						...
						<br>
						<input type = 'submit' value = 'Rate' name = 'rate' class = 'button1'>
					</div>
				</form>";
		}
		if($discussion){
			echo "<form method = 'post'>
					<div class='form-group'>
						...
						<br>
						<input type = 'submit' value = 'Comment' name = 'submit' class = 'button1'>
					</div>
				</form>";
		}
		if($comment != 0){
							...
							echo "<tbody>
									<tr>
										...
										if($user[$i] == $_SESSION['id']){
											echo "<a class = 'button2' href='remove_comment.php?comment=".$comment[$i]."'>Remove Comment</a>";
										}
								echo"	</td>
									</tr>
								</tbody>";
	...
	elseif($category == 2){
		...
		if($download){
			echo "<div class = 'row'>
					<div class = 'col-md-2'>
						<a class = 'button2' href='file_download.php?name=$path'>Download</a>
					</div>
					<div class = 'col-md-2'>
						<form method = 'post'>
							<div class='form-group'>
			...
			echo "<div class = 'row'>
					...
					<div class = 'col-md-3'>
						<form method = 'post'>
							<div class='form-group'>
								<input type = 'submit' value = 'Subscribe' name = 'subscribe' class = 'button1'>
							</div>
						</form>
					</div>
					<div class = 'col-md-3'>
		...
		if($download){
			echo "<div class = 'row'>
					...
					<div class = 'col-md-2'>
						<form method = 'post'>
							<div class='form-group'>
								<input type = 'submit' value = 'Favourites' name = 'favourites' class = 'button1'>
							</div>
						</form>
					</div>
					<div class = 'col-md-2'>
