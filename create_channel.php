...
if($_SESSION['id'] == 1){
	...
	echo "<form method = 'post' id = 'channel'>
		...
		<div class='form-group'>
			...
			<input type='text' name = 'name' class='form-control' id='' placeholder='Enter Channel Name' required>
		</div>
		<div class='form-group'>
		...
		<input type = 'submit' value = 'Create Channel' name = 'submit' class = 'button3'>
