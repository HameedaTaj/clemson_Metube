...
if($_SESSION['id'] == 1){
	...
	<div class='form-group'>
		...
		<input type='text' name = 'name' class='form-control' id='' placeholder='Enter Group Name' required>
	</div>

	<div class='form-group'>
		<label>Description</label>
		<textarea class='form-control' rows='5' name='description' placeholder='Enter Group Description Here'></textarea>
	</div>

	<div class='form-group'>
		<input type = 'submit' value = 'Create Group' name = 'submit' class = 'button3'>
	</div>";
}
?>
