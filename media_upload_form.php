...
if($check == false){
	...
	while ($row = mysqli_fetch_object($result)){
		...
		<div class='form-group'>
			...
			<input type='text' name = 'description' class='form-control' id='' placeholder='Enter Media Description Here' required>
		</div>
		...
		<input type = 'submit' value = 'Upload' name = 'submit' class = 'button1'>
		</form>";
}
