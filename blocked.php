...
if(mysqli_num_rows($contacts) == 0){
	...
	if($count >= 1){
		...
		echo"			</table>
						...
						<input type = 'submit' value = 'Add to Friends List' name = 'addFriend' class = 'button3'>
						<input type = 'submit' value = 'Add to Contact List' name = 'addContacts' class = 'button3'>
						<input type = 'submit' value = 'Remove Contact' name = 'remove' class = 'button3'>
						</div>
					</div>
			</form>";
	}
