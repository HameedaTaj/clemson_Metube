...
if($_SESSION['id'] == 1){
	...
	echo "<form method = 'post' id = 'playlist'>
		...
		<div class='form-group'>
			...
			<input type='text' name = 'name' class='form-control' id='' placeholder='Enter Playlist Name' required>
		</div>
		<div class='form-group'>
		...
		<input type = 'submit' value = 'Create Playlist' name = 'submit' class = 'button3'>
