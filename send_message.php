...
if($_SESSION['id'] == 1){
	...
	echo "			</select>
					...
					<div class='form-group'>
						<label>Message:</label>
						<textarea class='form-control' rows='5' name='message' placeholder='Enter your message here' form = 'messaging'></textarea>
						<br>
						<input type = 'submit' value = 'Send Message' name = 'submit' class = 'button3'>
					</div>
				</form>
				";
